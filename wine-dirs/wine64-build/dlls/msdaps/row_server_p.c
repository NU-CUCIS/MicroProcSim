/*** Autogenerated by WIDL 8.0-rc1 from ../wine-source/dlls/msdaps/row_server.idl - Do not edit ***/
...
#define TYPE_FORMAT_STRING_SIZE 2149
    ...
    DBBINDING **prgBindings)
{
    ...
    RpcExcept(__frame->_StubMsg.dwStubPhase != PROXY_SENDRECEIVE)
    {
        ...
        NdrClearOutParameters( &__frame->_StubMsg, &__MIDL_TypeFormatString.Format[2140], (void *)prgBindings );
    ...
    DBREFCOUNT *pcRefCount)
{
    ...
    RpcExcept(__frame->_StubMsg.dwStubPhase != PROXY_SENDRECEIVE)
    {
        NdrClearOutParameters( &__frame->_StubMsg, &__MIDL_TypeFormatString.Format[2144], (void *)pcRefCount );
...
/* 2118 (DBBINDING *) */
        ...
        0x4c,	/* FC_EMBEDDED_COMPLEX */
        0x0,
        NdrFcShort(0xff9e),	/* Offset= -98 (2034) */
        0x5c,	/* FC_PAD */
        0x5b,	/* FC_END */
/* 2136 */
        0x13, 0x0,	/* FC_OP */
        NdrFcShort(0xffec),	/* Offset= -20 (2118) */
/* 2140 (DBBINDING **) */
        0x11, 0x14,		/* FC_RP [allocated_on_stack] [pointer_deref] */
        NdrFcShort(0xfffa),	/* Offset= -6 (2136) */
/* 2144 (DBREFCOUNT *) */
        0x12, 0x8,	/* FC_UP [simple_pointer] */
        0xb9,	/* FC_UINT3264 */
        0x5c,	/* FC_PAD */
