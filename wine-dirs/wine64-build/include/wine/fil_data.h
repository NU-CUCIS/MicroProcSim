/*** Autogenerated by WIDL 8.0-rc1 from ../wine-source/include/wine/fil_data.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static __WIDL_INLINE HRESULT IAMFilterData_QueryInterface(IAMFilterData* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static __WIDL_INLINE ULONG IAMFilterData_AddRef(IAMFilterData* This) {
    return This->lpVtbl->AddRef(This);
}
static __WIDL_INLINE ULONG IAMFilterData_Release(IAMFilterData* This) {
    return This->lpVtbl->Release(This);
}
/*** IAMFilterData methods ***/
static __WIDL_INLINE HRESULT IAMFilterData_ParseFilterData(IAMFilterData* This,BYTE *data,ULONG size,BYTE **regfilter) {
    return This->lpVtbl->ParseFilterData(This,data,size,regfilter);
}
static __WIDL_INLINE HRESULT IAMFilterData_CreateFilterData(IAMFilterData* This,REGFILTER2 *regfilter,BYTE **data,ULONG *size) {
