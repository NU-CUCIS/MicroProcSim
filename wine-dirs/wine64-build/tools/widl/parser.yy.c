...
char *parser_text;
#line 1 "../wine-source/tools/widl/parser.l"
/* -*-C-*-
 * IDL Compiler
 *
...
#line 44 "../wine-source/tools/widl/parser.l"
 ...
 **************************************************************************
 */
#line 813 "tools/widl/parser.yy.c"
...
#line 126 "../wine-source/tools/widl/parser.l"

#line 1012 "tools/widl/parser.yy.c"
...
case 1:
YY_RULE_SETUP
#line 127 "../wine-source/tools/widl/parser.l"
yy_push_state(PP_PRAGMA);
	YY_BREAK
case 2:
YY_RULE_SETUP
#line 128 "../wine-source/tools/widl/parser.l"
yy_push_state(PP_LINE);
	YY_BREAK
case 3:
YY_RULE_SETUP
#line 129 "../wine-source/tools/widl/parser.l"
{
                            int lineno;
                            char *cptr, *fname;
                            yy_pop_state();
...
case 4:
YY_RULE_SETUP
#line 147 "../wine-source/tools/widl/parser.l"
yyless(9); yy_pop_state(); return tCPPQUOTE;
	YY_BREAK
case 5:
YY_RULE_SETUP
#line 148 "../wine-source/tools/widl/parser.l"
{
                            if(import_stack_ptr) {
                                if(!winrt_mode)
...
case 6:
YY_RULE_SETUP
#line 164 "../wine-source/tools/widl/parser.l"
parser_lval.str = xstrdup(parser_text); yy_pop_state(); return aPRAGMA;
	YY_BREAK
case 7:
YY_RULE_SETUP
#line 165 "../wine-source/tools/widl/parser.l"
return tPRAGMA_WARNING;
	YY_BREAK
case 8:
YY_RULE_SETUP
#line 166 "../wine-source/tools/widl/parser.l"
yy_push_state(QUOTE); cbufidx = 0;
	YY_BREAK
case 9:
YY_RULE_SETUP
#line 167 "../wine-source/tools/widl/parser.l"
{
				yy_pop_state();
...
case 10:
YY_RULE_SETUP
#line 172 "../wine-source/tools/widl/parser.l"
yy_push_state(WSTRQUOTE); cbufidx = 0;
	YY_BREAK
case 11:
YY_RULE_SETUP
#line 173 "../wine-source/tools/widl/parser.l"
{
				yy_pop_state();
				parser_lval.str = get_buffered_cstring();
				return aWSTRING;
...
case 12:
YY_RULE_SETUP
#line 178 "../wine-source/tools/widl/parser.l"
yy_push_state(SQUOTE); cbufidx = 0;
	YY_BREAK
case 13:
YY_RULE_SETUP
#line 179 "../wine-source/tools/widl/parser.l"
{
				yy_pop_state();
				parser_lval.str = get_buffered_cstring();
				return aSQSTRING;
	...
	YY_BREAK
case 14:
#line 185 "../wine-source/tools/widl/parser.l"
case 15:
YY_RULE_SETUP
#line 185 "../wine-source/tools/widl/parser.l"
...
case 16:
YY_RULE_SETUP
#line 186 "../wine-source/tools/widl/parser.l"
addcchar(parser_text[1]);
	YY_BREAK
case 17:
YY_RULE_SETUP
#line 187 "../wine-source/tools/widl/parser.l"
addcchar('\\'); addcchar(parser_text[1]);
	YY_BREAK
case 18:
YY_RULE_SETUP
#line 188 "../wine-source/tools/widl/parser.l"
addcchar(parser_text[0]);
	YY_BREAK
case 19:
YY_RULE_SETUP
#line 189 "../wine-source/tools/widl/parser.l"
yy_push_state(ATTR); return '[';
	YY_BREAK
case 20:
YY_RULE_SETUP
#line 190 "../wine-source/tools/widl/parser.l"
yy_pop_state(); return ']';
	YY_BREAK
case 21:
YY_RULE_SETUP
#line 191 "../wine-source/tools/widl/parser.l"
return attr_token(parser_text);
	YY_BREAK
case 22:
YY_RULE_SETUP
#line 192 "../wine-source/tools/widl/parser.l"
{
...
case 23:
YY_RULE_SETUP
#line 196 "../wine-source/tools/widl/parser.l"
{
...
case 24:
YY_RULE_SETUP
#line 200 "../wine-source/tools/widl/parser.l"
{
				parser_lval.num = xstrtoul(parser_text, NULL, 0);
				return aNUM;
			}
...
case 25:
YY_RULE_SETUP
#line 204 "../wine-source/tools/widl/parser.l"
{
...
YY_DO_BEFORE_ACTION; /* set up parser_text again */
YY_RULE_SETUP
#line 208 "../wine-source/tools/widl/parser.l"
return tSAFEARRAY;
	YY_BREAK
case 27:
YY_RULE_SETUP
#line 209 "../wine-source/tools/widl/parser.l"
return kw_token(parser_text);
	YY_BREAK
case 28:
/* rule 28 can match eol */
YY_RULE_SETUP
#line 210 "../wine-source/tools/widl/parser.l"
line_number++;
	YY_BREAK
case 29:
YY_RULE_SETUP
#line 211 "../wine-source/tools/widl/parser.l"

	YY_BREAK
case 30:
YY_RULE_SETUP
#line 212 "../wine-source/tools/widl/parser.l"
return SHL;
	YY_BREAK
case 31:
YY_RULE_SETUP
#line 213 "../wine-source/tools/widl/parser.l"
return SHR;
	YY_BREAK
case 32:
YY_RULE_SETUP
#line 214 "../wine-source/tools/widl/parser.l"
return MEMBERPTR;
	YY_BREAK
case 33:
YY_RULE_SETUP
#line 215 "../wine-source/tools/widl/parser.l"
return EQUALITY;
	YY_BREAK
case 34:
YY_RULE_SETUP
#line 216 "../wine-source/tools/widl/parser.l"
return INEQUALITY;
	YY_BREAK
case 35:
YY_RULE_SETUP
#line 217 "../wine-source/tools/widl/parser.l"
return GREATEREQUAL;
	YY_BREAK
case 36:
YY_RULE_SETUP
#line 218 "../wine-source/tools/widl/parser.l"
return LESSEQUAL;
	YY_BREAK
case 37:
YY_RULE_SETUP
#line 219 "../wine-source/tools/widl/parser.l"
return LOGICALOR;
	YY_BREAK
case 38:
YY_RULE_SETUP
#line 220 "../wine-source/tools/widl/parser.l"
return LOGICALAND;
	YY_BREAK
case 39:
YY_RULE_SETUP
#line 221 "../wine-source/tools/widl/parser.l"
return ELLIPSIS;
	YY_BREAK
case 40:
YY_RULE_SETUP
#line 222 "../wine-source/tools/widl/parser.l"
...
#line 223 "../wine-source/tools/widl/parser.l"
{
                            if (import_stack_ptr)
                                return aEOF;
                            if (acf_name)
...
case 41:
YY_RULE_SETUP
#line 233 "../wine-source/tools/widl/parser.l"
ECHO;
	YY_BREAK
#line 1373 "tools/widl/parser.yy.c"
